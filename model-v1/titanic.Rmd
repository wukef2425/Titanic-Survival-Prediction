...
# 创建 FamilySize 列，它是 SibSp 和 Parch 列的和，加上1（计算乘客本人）
titanic_data$FamilySize <- titanic_data$SibSp + titanic_data$Parch + 1

titanic_data <- model.matrix(~ Pclass + Sex + AgeGroup + FamilySize, data = titanic_data)
titanic_data <- titanic_data[, -1] # 删除第一列（避免虚拟变量陷阱）
